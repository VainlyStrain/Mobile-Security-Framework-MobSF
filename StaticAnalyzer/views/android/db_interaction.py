...
def get_context_from_db_entry(db_entry: QuerySet) -> dict:
    ...
    try:
        ...
        context = {
            ...
            'libscout_analysis': python_dict(db_entry[0].LIBSCOUT_ANALYSIS),
            'libid_analysis': python_dict(db_entry[0].LIBID_ANALYSIS),
...
def get_context_from_analysis(app_dic,
    ...
    try:
        context = {
            ...
            'libscout_analysis': lib_an_dic['libscout'],
            'libid_analysis': lib_an_dic['libid'],
